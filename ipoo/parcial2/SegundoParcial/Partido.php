...
class Partido
{
    ...
    public function darEquipoGanador()
    {
        ...
        } else if ($this->getCantGolesE2() > $this->getCantGolesE1()) {
    ...
    {
        $coeficiente = $this->getCoefBase() * ($this->getCantGolesE1() + $this->getCantGolesE2()) * ($this->getObjEquipo1()->getCantJugadores() * 2);
        return $coeficiente;
    }
